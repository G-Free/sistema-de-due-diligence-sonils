...
export const mockEntities: Entity[] = [
  ...
  { id: '3', entityType: EntityType.Individual, name: 'Diogo Costa - Consultoria', category: 'Consultoria Jurídica', riskLevel: RiskLevel.Low, status: LegalStatus.Suspended, onboardingDate: '2024-05-10', country: 'Angola', nif: '5000789012', commercialRegistration: 'N/A', beneficialOwner: 'N/A', address: 'Largo do Kinaxixi, 789, Luanda', services: ['Due Diligence Legal', 'Compliance Regulatório'], 
    contact: { 
      name: 'Diogo Costa', 
...
export let angolanLaws: DocumentItem[] = [
    { id: 'al1', title: 'Lei da Probidade Pública (Lei n.º 3/10)', description: 'Diploma que estabelece os princípios e normas que regem a conduta dos servidores públicos.' },
    { id: 'al2', title: 'Lei de Prevenção e Combate ao Branqueamento de Capitais (Lei n.º 5/20)', description: 'Medidas para prevenir a utilização do sistema financeiro para lavagem de dinheiro.' },
    { id: 'al3', title: 'Lei de Proteção de Dados Pessoais (Lei n.º 22/11)', description: 'Assegura a proteção da privacidade e dos dados pessoais dos cidadãos.' },
    { id: 'al4', title: 'Código Penal Angolano (artigos sobre corrupção)', description: 'Disposições legais que criminalizam atos de corrupção ativa e passiva.' },
];

export let internationalNorms: DocumentItem[] = [
    { id: 'in1', title: 'ISO 37001 (Sistemas de Gestão Antissuborno)', description: 'Norma internacional que especifica os requisitos para um sistema de gestão para prevenir o suborno.' },
    { id: 'in2', title: 'Foreign Corrupt Practices Act (FCPA - EUA)', description: 'Lei americana que proíbe o pagamento de subornos a funcionários estrangeiros.' },
    { id: 'in3', title: 'UK Bribery Act 2010 (Reino Unido)', description: 'Legislação britânica abrangente sobre corrupção e suborno.' },
    { id: 'in4', title: 'Recomendações do GAFI/FATF', description: 'Padrões internacionais para combater a lavagem de dinheiro e o financiamento do terrorismo.' },
];

export let mockIntegrations: Integration[] = [
    { id: 'int1', name: "OFAC Sanctions List", type: "Lista de Sanções Internacional", status: "Ativa" },
    { id: 'int2', name: "United Nations (UN) List", type: "Lista de Sanções Internacional", status: "Ativa" },
    { id: 'int3', name: "European Union (EU) List", type: "Lista de Sanções Internacional", status: "Ativa" },
    { id: 'int4', name: "African Union (AU) List", type: "Lista de Sanções Regional", status: "Inativa" },
    { id: 'int5', name: "AGT (NIF Validation)", type: "Validação Local (Angola)", status: "Ativa" },
    { id: 'int6', name: "Power BI", type: "Business Intelligence", status: "Ativa" },
];
