            ...
            <div className="bg-card p-6 rounded-lg shadow-sm max-w-4xl mx-auto">
                <div className="flex justify-between items-start mb-6">
                    <div>
                     ...
                     <button onClick={() => onModuleChange('menu-dashboard')} className="bg-danger/10 hover:bg-danger/20 text-danger font-semibold py-2 px-4 rounded-lg transition-colors text-sm shrink-0">
                        Sair sem Salvar
                    </button>
                </div>
                ...
                {!quiz ? (
                    <div>
                        ...
                        <button
                            ...
                            className="bg-secondary hover:bg-secondary-hover text-primary font-bold py-3 px-4 rounded-lg w-full flex items-center justify-center transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed"
                        >
                            {isLoading ? (
                            <>
