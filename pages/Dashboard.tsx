...
const documentStatusMap: Record<DocumentStatus, { label: string, color: string }> = {
    ...
    'Expirado': { label: 'Expirado', color: '#DA291C' },
    'Recebido': { label: 'Recebido', color: '#0ea5e9' },
};
                    ...
                    <table className="w-full text-sm text-left text-text-secondary">
                        ...
                        <tbody className="divide-y divide-border">
                            ...
                            {highRiskOrCriticalEntities.length === 0 && (
                                <tr><td colSpan={2} className="text-center p-4">Nenhuma entidade de risco alto ou crítico encontrada.</td></tr>
                            )}
                        </tbody>
                    </table>
                </div>
                        ...
                        <AreaChart data={expiringDocsData} margin={{ top: 5, right: 20, left: -10, bottom: 5 }}>
                            <defs>
                                <linearGradient id="colorVencimentos" x1="0" y1="0" x2="0" y2="1">
                                    <stop offset="5%" stopColor={PIE_COLORS[0]} stopOpacity={0.8}/>
                            ...
                            <Legend iconSize={10} />
                            <Area type="monotone" dataKey="Vencimentos" stroke={PIE_COLORS[0]} fillOpacity={1} fill="url(#colorVencimentos)" strokeWidth={2} />
                        </AreaChart>
                    </ResponsiveContainer>
                </div>
            </div>
                    ...
                    <table className="w-full text-sm text-left text-text-secondary">
                        ...
                        <tbody className="divide-y divide-border">
                            ...
                            {entitiesWithCriticalDocs.length === 0 && (
                                <tr><td colSpan={4} className="text-center p-4">Nenhuma entidade com documentos pendentes ou expirados.</td></tr>
                            )}
                        </tbody>
                    </table>
                 </div>
                  ...
                  <div style={{ width: '100%', height: 300 }}>
                    <ResponsiveContainer>
                        <BarChart data={campaignsData} margin={{ top: 5, right: 20, left: -10, bottom: 5 }}>
                            ...
                            <Tooltip wrapperClassName="!border-border !bg-card !shadow-lg" cursor={{fill: 'rgba(0, 0, 0, 0.05)'}} />
                            <Legend iconSize={10} />
                            <Bar dataKey="Conclusão" fill={PIE_COLORS[0]} radius={[4, 4, 0, 0]} />
                        </BarChart>
                    </ResponsiveContainer>
                  </div>
              </div>
