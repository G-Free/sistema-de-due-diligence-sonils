    ...
    <div className="bg-card p-6 rounded-lg shadow-sm">
      ...
      <div className="bg-background p-8 rounded-lg border border-border text-center">
        ...
        <div className="mt-6 flex flex-col sm:flex-row justify-center gap-4">
            <button onClick={() => alert('A iniciar o download do template offline...')} className="bg-secondary hover:bg-secondary-hover text-primary font-semibold py-2 px-6 rounded-lg transition-colors">
                Descarregar Template
            </button>
            <button onClick={() => alert('Funcionalidade de upload em desenvolvimento.')} className="bg-gray-200 hover:bg-gray-300 text-text-main font-semibold py-2 px-6 rounded-lg transition-colors">
                Carregar Ficheiro
            </button>
        </div>
      </div>
